...
class iOS26NativeTabBarManager: NSObject {
    ...
    private func setupTabBarAppearance(_ tabBar: UITabBarController) {
        ...
        // 1. Setup the Liquid Glass Effect
        // Use .systemChromeMaterial for a thicker, more "premium" glass, 
        // or .systemUltraThinMaterial for the subtle look you had.
        appearance.configureWithDefaultBackground()
        appearance.backgroundEffect = UIBlurEffect(style: .systemChromeMaterial) 
        appearance.backgroundColor = UIColor.systemBackground.withAlphaComponent(0.7)
        appearance.shadowColor = .clear // Keeps the "floating" glass look without a hard line

        // 2. FORCE "Stacked" Layout (Icon Top, Text Bottom)
        // This prevents the bar from shrinking to "Inline" mode (Icon Left, Text Right)
        // which often happens on iPads or Landscape modes.
        let itemAppearance = UITabBarItemAppearance()
        
        // Apply styling to the item (optional customization)
        // itemAppearance.normal.iconColor = .secondaryLabel
        // itemAppearance.selected.iconColor = .systemBlue
        
        // Apply this stacked item layout to ALL geometric configurations
        appearance.stackedLayoutAppearance = itemAppearance
        appearance.inlineLayoutAppearance = itemAppearance
        appearance.compactInlineLayoutAppearance = itemAppearance

        // 3. Assign this "locked" appearance to ALL scroll states
        // This ensures it looks exactly the same whether you are scrolling or idle.
        tabBar.tabBar.standardAppearance = appearance
